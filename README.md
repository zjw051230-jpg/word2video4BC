...
当前工具版本：`2.1.0`。首次安装会把官方仓库、main 分支和本地 Git 工作副本记录到工作区隐藏目录 `.word2video4BC`。以后无需再次提供链接，只要对 Codex 说“更新视频工具”，Codex 就会在该工作副本执行 `git pull --ff-only origin main`，再只更新工具白名单。
